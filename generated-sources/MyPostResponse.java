...
public class MyPostResponse {
    ...
    public MyPostResponse withData(String data) {
        this.data = data;
        return this;
    }
    ...
    public MyPostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MyPostResponse) == false) {
            return false;
        }
        MyPostResponse rhs = ((MyPostResponse) other);
