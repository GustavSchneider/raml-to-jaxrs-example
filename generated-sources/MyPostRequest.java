...
public class MyPostRequest {
    ...
    public MyPostRequest withData(String data) {
        this.data = data;
        return this;
    }
    ...
    public MyPostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MyPostRequest) == false) {
            return false;
        }
        MyPostRequest rhs = ((MyPostRequest) other);
